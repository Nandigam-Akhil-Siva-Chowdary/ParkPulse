...
<div align="center">
  <svg width="800" height="200" xmlns="http://www.w3.org/2000/svg">
    <rect width="800" height="200" fill="#0f0f1a" rx="20"/>
    <!-- Radar screen -->
    <circle cx="200" cy="100" r="80" fill="none" stroke="#00ffcc" stroke-width="2" opacity="0.6"/>
    <circle cx="200" cy="100" r="60" fill="none" stroke="#00ffcc" stroke-width="1" opacity="0.4"/>
    <circle cx="200" cy="100" r="40" fill="none" stroke="#00ffcc" stroke-width="1" opacity="0.3"/>
    <circle cx="200" cy="100" r="20" fill="none" stroke="#00ffcc" stroke-width="1" opacity="0.2"/>
    <line x1="200" y1="100" x2="260" y2="60" stroke="#ff3366" stroke-width="2">
      <animateTransform attributeName="transform" type="rotate" from="0 200 100" to="360 200 100" dur="3s" repeatCount="indefinite"/>
    </line>
    <!-- Blips -->
    <circle cx="250" cy="80" r="5" fill="#ff3366">
      <animate attributeName="opacity" values="0;1;0" dur="1s" repeatCount="indefinite"/>
    </circle>
    <circle cx="170" cy="140" r="4" fill="#ff3366">
      <animate attributeName="opacity" values="0;1;0" dur="1.2s" repeatCount="indefinite"/>
    </circle>
    <!-- Parking slots visualization -->
    <rect x="400" y="40" width="80" height="60" rx="8" fill="#2d2d44" stroke="#00ffcc" stroke-width="2"/>
    <text x="440" y="70" fill="#00ffcc" text-anchor="middle" font-size="12">SLOT 1</text>
    <text x="440" y="85" fill="#00ffcc" text-anchor="middle" font-size="10">FREE</text>
    <circle cx="410" cy="55" r="5" fill="#00ffcc">
      <animate attributeName="opacity" values="1;0.3;1" dur="1s" repeatCount="indefinite"/>
    </circle>

    <rect x="490" y="40" width="80" height="60" rx="8" fill="#2d2d44" stroke="#ff3366" stroke-width="2"/>
    <text x="530" y="70" fill="#ff3366" text-anchor="middle" font-size="12">SLOT 2</text>
    <text x="530" y="85" fill="#ff3366" text-anchor="middle" font-size="10">OCCUPIED</text>
    <circle cx="500" cy="55" r="5" fill="#ff3366">
      <animate attributeName="opacity" values="1;0.3;1" dur="1.5s" repeatCount="indefinite"/>
    </circle>

    <rect x="400" y="120" width="80" height="60" rx="8" fill="#2d2d44" stroke="#ff3366" stroke-width="2"/>
    <text x="440" y="150" fill="#ff3366" text-anchor="middle" font-size="12">SLOT 3</text>
    <text x="440" y="165" fill="#ff3366" text-anchor="middle" font-size="10">OCCUPIED</text>

    <rect x="490" y="120" width="80" height="60" rx="8" fill="#2d2d44" stroke="#00ffcc" stroke-width="2"/>
    <text x="530" y="150" fill="#00ffcc" text-anchor="middle" font-size="12">SLOT 4</text>
    <text x="530" y="165" fill="#00ffcc" text-anchor="middle" font-size="10">FREE</text>

    <!-- Gate animation -->
    <rect x="640" y="80" width="120" height="10" fill="#666" rx="5"/>
    <rect x="640" y="80" width="60" height="10" fill="#00ffcc" rx="5">
      <animate attributeName="width" values="60;0;60" dur="3s" repeatCount="indefinite"/>
    </rect>
    <text x="700" y="70" fill="#ccc" text-anchor="middle" font-size="10">ENTRY GATE</text>
  </svg>
</div>
